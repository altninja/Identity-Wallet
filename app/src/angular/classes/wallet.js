...
class Wallet {
    ...
    setAdditionalData (data) {
        this.isSetupFinished = data.isSetupFinished;
        this.profilePicture = data.profilePicture;
        this.lastRetrievedEthTxRecord = data.lastRetrievedEthTxRecord;
        this.lastRetrievedTokenTxRecord = data.lastRetrievedTokenTxRecord;
        this.airDropCode = data.airDropCode;
        this.name = data.name;
    }
